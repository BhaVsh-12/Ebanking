...
<form action="ddata.jsp" method="get" onsubmit="return validatePassword(event)">
	<div>
	<caption><br><h3>Deposite Amount</h3><br></caption><br><br>
	<input type="text" id="account" name="account" placeholder="Enter Account No" required>
		<br><br>
	<input type="text" id="balance" name="deposite" placeholder="Enter Deposite Amount" required>
	<br><br>
